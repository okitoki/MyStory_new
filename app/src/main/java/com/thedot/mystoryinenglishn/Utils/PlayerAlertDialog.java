...
public class PlayerAlertDialog extends DialogFragment{
    ...
    public static PlayerAlertDialog newInstance(int title,String subject,String filename) {
        PlayerAlertDialog frag = new PlayerAlertDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView subject = (TextView) view.findViewById(R.id.record_unit_subject);
        TextView filename = (TextView) view.findViewById(R.id.record_unit_filename);
